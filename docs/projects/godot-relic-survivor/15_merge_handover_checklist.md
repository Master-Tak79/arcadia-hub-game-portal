...
2. merge 전 최신 자동검증 실행:
   ...
   - (포함 시나리오: `boss_pattern`, `boss_phase2`, `elite_loop`, `relic_loop`, `event_loop`, `character_ranger`, `character_warden`, `active_ranger`, `active_warden`, `tree_ranger`, `tree_warden`, `tree_ui`, `weapon_pierce`, `weapon_dot`, `weapon_aoe`, `meta_loop`)
3. 필요 시 leak 추적:
